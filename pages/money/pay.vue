	...
	<view class="app">
		...
		<view class="pay-type-list">
			<view class="type-item b-b" @click="changePayType(1)">
				<text class="iconfont icon-paypal"></text>
				<view class="con">
					<text class="tit">PayPal</text>
					<text> Recommend</text>
				</view>
				<label class="radio">
			...
			<view class="type-item b-b" @click="changePayType(2)">
				<text class="iconfont icon-cc-apple-pay"></text>
				<view class="con">
					<text class="tit">ApplePay</text>
				</view>
				<label class="radio">
		...
		<text class="mix-btn" @click="confirm">Pay</text>
	</view>
</template>
