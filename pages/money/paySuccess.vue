<template>
	<view class="content">
		...
		<view class="btn-group">
			<navigator url="/pages/order/order?state=0" open-type="redirect" class="mix-btn">Check Orders</navigator>
			<navigator url="/pages/index/index" open-type="switchTab" class="mix-btn hollow">Bact to Home</navigator>
		</view>
	</view>
</template>
