	...
	<view>
		...
		<view class="info">
			...
			<view class="title">
				...
				<text :class="{Skeleton:!loaded}">First Letter：{{brand.firstLetter}}</text>
			</view>
			<view>
		...
		<!-- 品牌故事 -->
		<view class="section-tit">Brand Story</view>
		<view class="brand-story">
			<text class="text">{{brand.brandStory}}</text>
		</view>
		<!-- 相关商品 -->
		<view class="section-tit">Products</view>
