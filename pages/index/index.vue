<template>
	<view class="container">
		...
		<view class="f-header m-t" @click="navToRecommendBrandPage()">
			...
			<view class="tit-box">
				<text class="tit">Recommend Brands</text>
				<text class="tit2">Directly from factory to consumer!</text>
			</view>
		...
		<view class="guess-section">
			<view v-for="(item, index) in brandList" :key="index" class="guess-item" @click="navToBrandDetailPage(item)">
				...
				<text class="title2">Product Count：{{item.productCount}}</text>
			</view>
		</view>
		...
		<view class="f-header m-t" v-if="homeFlashPromotion!==null">
			...
			<view class="tit-box">
				<text class="tit">Flash Sale</text>
				<text class="tit2">Next Start At {{homeFlashPromotion.nextStartTime | formatTime}}</text>
			</view>
			<view class="tit-box">
				<text class="tit2" style="text-align: right;">Time Left：</text>
		...
		<view class="f-header m-t" @click="navToNewProudctListPage()">
			...
			<view class="tit-box">
				<text class="tit">New In</text>
				<text class="tit2">Searching for the best things for you</text>
			</view>
			<text class="yticon icon-you"></text>
		</view>
		...
		<view class="f-header m-t" @click="navToHotProudctListPage()">
			...
			<view class="tit-box">
				<text class="tit">Recommendation</text>
				<text class="tit2">Everyone likes them!</text>
			</view>
			<text class="yticon icon-you"></text>
		</view>
		...
		<view class="f-header m-t">
			...
			<view class="tit-box">
				<text class="tit">Guess You Like</text>
				<text class="tit2">Everything you like is here</text>
			</view>
			<text class="yticon icon-you" v-show="false"></text>
		</view>
