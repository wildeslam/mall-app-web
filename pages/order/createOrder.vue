	...
	<view>
		...
		<view class="goods-section">
			<view class="g-header b-b">
				<text class="name">Product Info</text>
			</view>
			<!-- 商品列表 -->
			<view class="g-item" v-for="item in cartPromotionItemList" :key="item.id">
				...
				<view class="right">
					...
					<text class="promotion clamp">{{item.reduceAmount == 0 ? "No Discount" : "Saved $" + item.reduceAmount}}</text>
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">Total</text>
				<text class="cell-tip">${{calcAmount.totalAmount}}</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">Freight</text>
				<text class="cell-tip">${{calcAmount.freightAmount}}</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">Discount</text>
			...
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">Credit Deduction</text>
				<text class="cell-tip red">-${{calcIntegrationAmount(useIntegration)}}</text>
			</view>
			<view class="yt-list-cell desc-cell">
				<text class="cell-tit clamp">Note</text>
				<input class="desc" type="text" v-model="desc" placeholder="Please Enter the Note" placeholder-class="placeholder" />
			</view>
		</view>
		...
		<view class="footer">
			...
			<text class="submit" @click="submit">CONFIRM</text>
		</view>
		...
		methods: {
			...
			submit() {
				...
				generateOrder(orderParam).then(response => {
					...
					uni.showModal({
						title: 'Hint',
						content: 'Do you want to pay immediately?',
						confirmText:'Pay',
						cancelText:'Cancel',
