...
<!-- 			<view class="c-row b-b" @click="toggleAttr">
		...
		<view class="eva-section">
			<view class="e-header">
				<text class="tit">Customer reviews</text>
				<text>(86)</text>
				<text class="tip">Good Review Rate 100%</text>
				<text class="yticon icon-you"></text>
			</view>
			<view class="eva-box">
				...
				<view class="right">
					...
					<text class="con">I got this for my nephew for Christmas and he loved it. It fit well, and looks great. It is very stylish, and goes well with all of his other nike apparel.</text>
					<view class="bot">
						<text class="attr">Color: Heather/Black</text>
		...
		<view class="page-bottom">
			...
			<view class="action-btn-group">
				<button type="primary" class=" action-btn no-border buy-now-btn" @click="buy">Buy Now</button>
				<button type="primary" class=" action-btn no-border add-cart-btn" @click="addToCart">Add Cart</button>
			</view>
		</view>
		...
		<view class="popup spec" :class="specClass" @touchmove.stop.prevent="stopPrevent" @click="toggleSpec">
			...
			<view class="layer attr-content" @click.stop="stopPrevent">
				...
				<button class="btn" @click="toggleSpec">Confirm</button>
			</view>
		</view>
		<!-- 属性-模态层弹窗 -->
	...
	export default {
		...
		methods: {
			...
			initPromotionTipList(data) {
				...
				if (promotionType == 0) {
					this.promotionTipList.push("No Promotion");
