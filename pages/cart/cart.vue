	...
	<view class="container">
		...
		<view v-if="!hasLogin || empty===true" class="empty">
			...
			<view v-if="hasLogin" class="empty-tips">
				Empty
				<navigator class="navigator" v-if="hasLogin" url="../index/index" open-type="switchTab">Go to Shopping></navigator>
			</view>
		...
		<view v-else>
			...
			<view class="action-section">
				...
				<button type="primary" class="no-border confirm-btn" @click="createOrder">Checkout</button>
			</view>
		</view>
	</view>
</template>
